...
internal static class DialogTheme
{
    ...
    public static readonly Color NameInk = Color.FromArgb(0xFF, 0xE8, 0xD9, 0xB8);
    public static readonly Color PrimaryInk = Color.FromArgb(0xFF, 0xF4, 0xF2, 0xEE);
    ...
    /// <summary>An engaged control (pin held down). Same warm off-white as the name, so
    /// "on" reads as lit rather than as a different colour scheme.</summary>
    public static readonly Color ActionInkActive = Color.FromArgb(0xFF, 0xE8, 0xD9, 0xB8);
    /// <summary>Waiting indicator. Warm off-white, not a saturated accent: a bright
    /// blue glyph on a dark plate is the other thing that reads as cheap.</summary>
    public static readonly Color IndicatorInk = Color.FromArgb(0xFF, 0xEA, 0xE2, 0xD2);
    ...
    /// <summary>Acrylic tint. The warm near-black of the old painted plate.</summary>
    public static readonly Color AcrylicTint = Color.FromArgb(0xFF, 0x14, 0x12, 0x10);
    ...
    public static readonly Color AcrylicFallback = Color.FromArgb(0xF2, 0x17, 0x15, 0x12);
    public static readonly Color CountdownTrackInk = Color.FromArgb(0x1A, 0xFF, 0xFF, 0xFF);
    public static readonly Color CountdownInk = Color.FromArgb(0xD9, 0xE8, 0xD9, 0xB8);
    /// <summary>Countdown bar while the pointer freezes it, so the freeze is visible.</summary>
    public static readonly Color CountdownFrozenInk = Color.FromArgb(0xFF, 0xE0, 0xA8, 0x55);
